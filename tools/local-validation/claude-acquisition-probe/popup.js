...
async function render(state) { const view = globalThis.QuotaBarProbeCore.popupView(state); slot.value = view.slot; planClass.value = view.planClass; output.textContent = JSON.stringify({ buildId: view.buildId, diagnostic: view.diagnostic, observation: view.observation }, null, 2); }
